...
public class WordCounter {
    ...
    public static Map<String, Integer> calculatedWord() {
        String words = "When the offensive resumed, the Turks received their first victory when the Greeks encountered stiff resistance in the battles of First and Second İnönü," +
        ...
        for (String letter : letters) {
            letter = letter.toLowerCase().replaceAll("[.,]", "");
